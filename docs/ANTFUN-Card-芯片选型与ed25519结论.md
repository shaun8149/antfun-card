...
> **决策更新(2026-07):无任何国产芯片要求。** → **选定 SE = NXP JCOP4 P71(J3R200)**:EAL6+、开放采购、secp256k1 生产验证(Keycard 在用)、开发卡无 NDA、双界面 NFC。THD89/国产线**不再追**(仅作历史记录留在下文)。国产 EAL6+ 供应稀缺的瓶颈对我们**不成立**。卡仍可深圳制造(NXP SE + 国内产线)。SOL 仍延后——与国别无关:无任何在售真卡有可验证的原生 ed25519。
