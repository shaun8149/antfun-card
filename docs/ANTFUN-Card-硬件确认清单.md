...
> **决策(2026-07):无国产芯片要求 → SE 选定 NXP JCOP4 P71(J3R200)。** 下文第二节的"国产 vs 国际"岔路作废,直接按 NXP 采购;THD89/华大不再列为候选。SOL 延后(无卡有原生 ed25519,与国别无关)。采购:先买 NXP JCOP4 P71 开发卡(Keycard 自家开发卡 + Satochip DIY 卡)+ 非接读卡器 + iPhone/Android 各一。
